    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_print:
                ...
                if (MainActivity.printerPresenter!=null) {
                    try {
                        MainActivity.printerPresenter.printerService.sendRAWData(getBaiduTestBytes(), null);
                        MainActivity.printerPresenter.printerService.lineWrap(3, null);
                        MainActivity.printerPresenter.printerService.cutPaper(null);
